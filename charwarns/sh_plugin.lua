...
ix.command.Add("CharWarn", {
    ...
    OnRun = function(self, client, character, reason)
        ...
        player:ChatNotify("Вам было выдано предупреждение от " .. client:GetName() .. "  Комментарий: " .. reason .. ". Будьте осторожны! Если вы получите слишком много предупреждений, ваш персонаж будет временно, либо перманентно заблокирован.")
        ...
        player:ChatNotify("Всего предупреждений: " .. newValue)
        player:Notify("Вы были заморожены на 10 секунд. Ознакомьтесь с предупреждением!")
